from configs.config import backbone_config, backbone_out_channels, cline_alpha, ps_feature_channels, ps_feature_index, M
...
model = dict(
    ...
    auxiliary_head=[dict(
        ...
        M=M,
        N=M ** 2,
        loss_decode=dict(type='PointLoss', loss_weight=1.0, alpha=cline_alpha, loss_name='loss_point_cline'))],
)
